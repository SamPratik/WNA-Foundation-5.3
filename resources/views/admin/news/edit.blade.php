  ...
  <div class="edit-news-form-container">
    <div class="container">
      <h2 class="text-center">Edit News</h2>
			<form class="" enctype="multipart/form-data" onsubmit="updateNews(event)">
				{{-- @method('PUT') --}}
				<div class="form-group">
          <label for=""><strong>Title</strong>:</label>
          <input name="title" id="title" type="text" class="form-control" value="{{ $new->title }}">
					<p class="error-message"></p>
        </div>
				<div class="form-group">
				  <label for=""><strong>Display image</strong></label>
				  <label class="btn btn-success" style="width:200px;margin-left:30px;">Choose File<input style="display:none;" type="file" name="newsImage" id="newsImage"></label>
					<span style="margin-left:20px;">[upload 640X400 image for better quality]</span>
					<p class="error-message"></p>
				</div>
				<div class="form-group">
          <label for=""><strong>Summary</strong></label>
          <textarea id="summary" class="form-control" name="summary" rows="5" cols="80">{{ $new->summary }}</textarea>
					<p class="error-message"></p>
        </div>
        <div class="form-group">
          <label for=""><strong>Description</strong></label>
          <textarea id="description" class="form-control" name="description" rows="25" cols="80">{{ $new->description }}</textarea>
					<p class="error-message"></p>
        </div>
